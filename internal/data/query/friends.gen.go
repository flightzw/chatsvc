...
func newFriend(db *gorm.DB, opts ...gen.DOOption) friend {
	...
	_friend.FriendNickname = field.NewString(tableName, "friend_nickname")
	_friend.FriendAvatarURL = field.NewString(tableName, "friend_avatar_url")
...
func (f *friend) updateTableName(table string) *friend {
	...
	f.FriendNickname = field.NewString(table, "friend_nickname")
	f.FriendAvatarURL = field.NewString(table, "friend_avatar_url")
...
func (f *friend) fillFieldMap() {
	...
	f.fieldMap["friend_nickname"] = f.FriendNickname
	f.fieldMap["friend_avatar_url"] = f.FriendAvatarURL
