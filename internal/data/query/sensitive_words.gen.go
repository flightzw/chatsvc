...
func newSensitiveWord(db *gorm.DB, opts ...gen.DOOption) sensitiveWord {
	...
	_sensitiveWord.ID = field.NewInt32(tableName, "id")
	_sensitiveWord.Content = field.NewString(tableName, "content")
	_sensitiveWord.Enabled = field.NewInt32(tableName, "enabled")
...
func (s *sensitiveWord) updateTableName(table string) *sensitiveWord {
	...
	s.Enabled = field.NewInt32(table, "enabled")
