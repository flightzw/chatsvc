...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.ParentID = field.NewInt32(tableName, "parent_id")
	_config.Key = field.NewString(tableName, "key")
	_config.Value = field.NewString(tableName, "value")
	_config.Comment = field.NewString(tableName, "comment")
...
type config struct {
	...
	ALL       field.Asterisk
	ID        field.Int32
	ParentID  field.Int32  // 上级配置 id
	Key       field.String // 配置名称
	Value     field.String // 配置参数
